...
awshost = "a2hjy1r5w8fmmo.iot.eu-west-2.amazonaws.com"      # Endpoint
awsport = 8883                                              # Port no.   
clientId = "DHT11"                                     # Thing_Name
thingName = "DHT11"                                    # Thing_Name
caPath = "root-CA.crt"                                      # Root_CA_Certificate_Name
certPath = "DHT11.cert.pem"                            # <Thing_Name>.cert.pem
keyPath = "DHT11.private.key"                          # <Thing_Name>.private.key
...
while 1==1:
    ...
    if connflag == True:
        ...
        mqttc.publish("temperature", temp, qos=1)        # topic: temperature # Publishing Temperature values
        mqttc.publish("umidity", umid, qos=1)        # topic: temperature # Publishing Temperature values
        print("msg sent: temperature " + "%.2f" % temp + "msg sent umidity " + "%.2f" % umid) # Print sent temperature msg on console
    else:
